# Generated by Django 5.1.15 on 2026-08-06 17:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('preferred_units', models.CharField(choices=[('metric', 'Metric'), ('imperial', 'Imperial')], default='imperial', max_length=10)),
                ...
                ('default_run_privacy', models.CharField(choices=[('public', 'Public'), ('followers', 'Followers only'), ('private', 'Private')], default='followers', max_length=10)),
